...
def PlayGame(Deck, RecentScores,SetAceHigh):
  LastCard = TCard()
  NextCard = TCard()
  GameOver = False
##  SetAceHigh = SetAceHighOrLow(Changed)
...
if __name__ == '__main__':
  ...
  while Choice != 'q':
    ...
    if Choice == '1':
      ...
      ShuffleDeck(Deck)
      SetAceHigh = SetAceHighOrLow(Changed)
      PlayGame(Deck, RecentScores,SetAceHigh)
    elif Choice == '2':
      LoadDeck(Deck)
      SetAceHigh = SetAceHighOrLow(Changed)
      PlayGame(Deck, RecentScores,SetAceHigh)
